# Search, Sort, Filter, Pagination functionality with React
...
1. Clone the repo
   ```sh
   git clone [https://github.com/Ajoy-paul11/Query-site.git](https://github.com/Ajoy-paul11/Query-site.git)
   ```
